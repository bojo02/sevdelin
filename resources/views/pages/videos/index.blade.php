...
<div class="container center up">
  <div class="row">
      ...
      <a href="{{route('video.create')}}" style="color:white;" type="button" class="btn btn-secondary btn-lg">Create</a>
      </div>
    <div class="col-sm-10">
        <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <a href="{{route('video.edit', ['video' => $video->id])}}" style="color:white;" type="button" class="btn btn-secondary">Edit</a>
  ...
  <ul class="pagination">
	...
	<li class="page-item"><a class="page-link" href="/video?page=1">1</a></li>
