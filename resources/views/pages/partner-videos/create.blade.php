...
<div class="container up">
  <div class="row center">
    <div class="col center">
        <h1>Upload Video</h1>
        <form action="{{route('partner-video.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div class="input-group mb-3">
                ...
                <textarea name="title" id="content" required type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"></textarea>
            </div>
            <p>Upload Video</p>
            <div class="input-group mb-3">
            ...
            <div class="input-group mb-3">
                <button type="submit" class="btn btn-success btn-lg">Upload Video</button>
            </div>
        </form>
    </div>
  </div>
